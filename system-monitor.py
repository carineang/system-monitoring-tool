...
def parse_arguments():
    parser = argparse.ArgumentParser(add_help=False, allow_abbrev=False, usage="python3 system-monitor.py [--start]")
    parser.add_argument("--start", action="store_true", help="Start system monitoring")
    return parser
